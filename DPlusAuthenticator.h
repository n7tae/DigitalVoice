...
public:
	...
	bool Process(std::map<std::string, SDATA *> &gwy_map, const bool reflectors, const bool repeaters);
...
private:
	...
	bool authenticate(std::map<std::string, SDATA *> &gwy_map, const bool reflectors, const bool repeaters);
};
